...
import { Award, Users, Target, Wrench, Mail, MapPin, Phone, Instagram } from 'lucide-react';
      ...
      <div className="bg-black text-white min-h-screen overflow-x-hidden relative font-['Poppins']">
        ...
        <section className="relative z-20 min-h-screen flex items-center justify-center">
          <div className="text-center px-6">
            <h1 className="mt-20 text-6xl md:text-8xl font-bold mb-6 text-white drop-shadow-2xl">
              ABOUT US
            </h1>
        ...
        <section className="relative z-20 py-5 px-6 md:px-12">
          <div className="max-w-7xl mx-auto">
            {/* About Section */}
            <div className="mb-20">
              <h2 className="text-4xl md:text-5xl font-extrabold mb-8 text-center text-white drop-shadow-lg">
            ...
            {/* Club Leads Section */}
            <div className="mb-20">
              <h2 className="text-4xl md:text-5xl font-extrabold mb-12 text-center text-white drop-shadow-lg">
                Club Leads
              </h2>
